      ...
      <div>
        ...
        <nav :class="['mt-8 flex flex-col gap-[8px]', isSidebarOpen ? 'px-[16px]' : 'px-[5px]']">
          <a
              ...
              activeSection === 'users' ? 'bg-color-purple-1 border-[1px] border-color-purple-2 text-color-blue-max font-semibold' : 'hover:bg-color-purple-1 hover:border-[1px] hover:border-color-purple-2 hover:text-color-blue-max hover:font-semibold',
              isSidebarOpen ? '' : 'justify-center'
            ]"
          >
            <UserPlus :size="24" />
            <span :class="['ml-4', isSidebarOpen ? '' : 'hidden']">Usuarios</span>
          </a>
          <a
              @click="setActiveSection('questionnaires')"
              :class="[
              'flex items-center p-4 font-medium cursor-pointer rounded-[8px] border-[1px] border-transparent',
              activeSection === 'questionnaires' || activeSection === 'editQuestionnaire'
