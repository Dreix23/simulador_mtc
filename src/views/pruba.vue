...
<template>
  ...
  <main class="main flex">
          ...
          <div v-for="topic in topics" :key="topic.id" class="border-b-2">
            ...
            <ul v-if="topic.expanded" class="space-y-1 text-sm mt-2">
              ...
              >
                ...
                <div
                  class="circle-alrt rounded-full border-2 border-red-400"
                ></div>
              </li>
            </ul>
          </div>
    ...
    <section class="right-pane">
      <div class="flex-grow p-4 overflow-y-auto container-question">
        ...
        <div
          class="bg-white px-[19px] pb-[27px] rounded"
          :style="{ fontSize: baseFontSize }"
        >
      ...
      <!-- Barra de zoom -->
      <div class="zoom-bar absolute bottom-4 right-4 flex items-center">
